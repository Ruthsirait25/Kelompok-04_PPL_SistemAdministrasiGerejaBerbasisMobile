...
await el1.click();
const el2 = await driver.$("xpath://android.widget.TextView[@resource-id=\"com.example.hkbptarutung:id/tv_rv_regislanding_title\" and @text=\"Registrasi jemaat baru\"]");
await el2.click();
const el3 = await driver.$("id:com.example.hkbptarutung:id/btn_lanjut");
await el3.click();
const el4 = await driver.$("id:android:id/button1");
await el4.click();
const el5 = await driver.$("id:com.example.hkbptarutung:id/btn_batal");
await el5.click();
