...
await el15.click();
const el16 = await driver.$("xpath://android.widget.TextView[@resource-id=\"com.example.hkbptarutung:id/tv_rv_regislanding_title\" and @text=\"Registrasi sidi\"]");
await el16.click();
const el17 = await driver.$("id:com.example.hkbptarutung:id/edt_cari_nama");
await el17.click();
await el17.addValue("christian");
const el18 = await driver.$("id:com.example.hkbptarutung:id/tv_person_name");
await el18.click();
const el19 = await driver.$("id:com.example.hkbptarutung:id/iv_btn_back");
await el19.click();
const el20 = await driver.$("accessibility id:default");
await el20.click();
const el21 = await driver.$("id:com.example.hkbptarutung:id/iv_btn_back");
await el21.click();
const el22 = await driver.$("xpath://android.widget.TextView[@text=\"Log out\"]");
await el22.click();
