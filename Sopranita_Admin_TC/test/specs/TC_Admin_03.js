...
(async () => {
  ...
  await el5.click();
  await el5.addValue("adminsuper@gmail.com");
  const el6 = await driver.$("id:com.example.hkbptarutung:id/edt_password");
  await el6.click();
  await el6.addValue("adminadmin");
  const el7 = await driver.$("id:com.example.hkbptarutung:id/btn_login");
  await el7.click();
