...
(async () => {
  ...
  await el15.click();
  const el16 = await driver.$("xpath://android.widget.TextView[@resource-id=\"com.example.hkbptarutung:id/tv_rv_regislanding_title\" and @text=\"Registrasi pemberkatan nikah\"]");
  await el16.click();
  const el17 = await driver.$("xpath:(//android.widget.TextView[@resource-id=\"com.example.hkbptarutung:id/tv_person_name\"])[2]");
  await el17.click();
