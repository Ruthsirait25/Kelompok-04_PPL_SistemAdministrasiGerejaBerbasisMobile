...
(async () => {
  ...
  await el15.click();
  const el16 = await driver.$("xpath://android.widget.TextView[@resource-id=\"com.example.hkbptarutung:id/tv_rv_regislanding_title\" and @text=\"Registrasi martupol\"]");
  await el16.click();
  const el17 = await driver.$("id:com.example.hkbptarutung:id/edt_cari_nama");
  await el17.click();
  await el17.addValue("marudut");
  const el18 = await driver.$("id:com.example.hkbptarutung:id/tv_person_name");
  await el18.click();
  const el19 = await driver.$("xpath://android.widget.TextView[@text=\"Home\"]");
  await el19.click();
