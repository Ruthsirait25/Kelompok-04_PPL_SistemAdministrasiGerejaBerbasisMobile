...
(async () => {
  ...
  await el3.click();
  const el4 = await driver.$("id:com.example.hkbptarutung:id/iv_acaraminggu");
  await el4.click();
  const el5 = await driver.$("id:com.example.hkbptarutung:id/iv_btn_back");
  await el5.click();
  const el6 = await driver.$("accessibility id:default");
  await el6.click();
