...
await el4.click();
const el5 = await driver.$("xpath://android.widget.TextView[@resource-id=\"com.example.hkbptarutung:id/tv_rv_regislanding_title\" and @text=\"Registrasi sidi\"]");
await el5.click();
...
await el7.click();
await el7.addValue("Silvany Putri Sipahutar");
...
await el13.click();
const el14 = await driver.$("xpath://android.widget.TextView[@text=\"Home\"]");
await el14.click();
const el15 = await driver.$("accessibility id:default");
await el15.click();
