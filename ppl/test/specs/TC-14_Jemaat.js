...
await el1.click();
await el1.addValue("ruthsirait24@gmail.c");
...
await el5.click();
const el6 = await driver.$("xpath://androidx.recyclerview.widget.RecyclerView[@resource-id=\"com.example.hkbptarutung:id/rv_registrasi\"]/android.widget.FrameLayout[1]");
await el6.click();
const el7 = await driver.$("id:com.example.hkbptarutung:id/edt_nik");
await el7.click();
const el8 = await driver.$("id:com.example.hkbptarutung:id/btn_batal");
await el8.click();
const el9 = await driver.$("id:com.example.hkbptarutung:id/iv_btn_back");
await el9.click();
const el10 = await driver.$("id:com.example.hkbptarutung:id/footer");
await el10.click();
