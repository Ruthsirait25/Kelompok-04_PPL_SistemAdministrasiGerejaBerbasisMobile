...
class WartaJemaatNew : AppCompatActivity() {
    ...
    private fun initListeners() {
        binding.apply {
            ...
            btnKetentuanBaptis.setOnClickListener {
                startActivity(Intent(this@WartaJemaatNew, PengumumanPage::class.java).apply {
                    putExtra("title", "Ketentuan Pendaftaran Baptis")
                    putExtra("desc", "Untuk melakukan Baptis, silakan memperhatikan ketentuan sebagai berikut:\n\n1. Akta Kelahiran\n2. Mengisi formulir Katekisasi Baptis\n3. Penulisan nama tidak singkat (termasuk nama orangtua)\n4. Surat pengantar dari Gereja asal, jika peserta dari gereja lain.")
                })
            }
            btnKetentuanSidi.setOnClickListener {
                startActivity(Intent(this@WartaJemaatNew, PengumumanPage::class.java))
            }
