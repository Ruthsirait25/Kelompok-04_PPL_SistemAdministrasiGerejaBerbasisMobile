...
import com.example.hkbptarutung.adapters.AdapterItemTamu
...
class HomeTamu : AppCompatActivity() {
    ...
    private var adapter = AdapterItemTamu(arrayListOf(
        "Registrasi Sidi Baptis",
        "Registrasi Martupol",
        "Registrasi Pindah Huria",
        "Registrasi Pemberkatan Nikah",
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.cardView2.adapter = adapter
    }
